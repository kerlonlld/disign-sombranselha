function HeroSection() {
  return (
    <section className="relative overflow-hidden rounded- border border-white/10 bg-slate-900/80 p-8 shadow-glow sm:p-12">
      <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-16">
        ...
        <div className="relative flex h-[28rem] w-full flex-1 items-center justify-center rounded- bg-gradient-to-br from-fuchsia-600/20 via-transparent to-amber-500/10 p-2 shadow-2xl backdrop-blur-sm lg:h-[36rem]">
          ...
          <div className="relative z-10 grid h-full w-full grid-cols-2 grid-rows-2 gap-2 text-sm text-slate-200">
